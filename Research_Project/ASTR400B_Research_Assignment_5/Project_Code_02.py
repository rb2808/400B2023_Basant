...
for i in range(len(Lxmw)):
    rem_x.append((Lxmw[i]*hpmmw + Lxm31[i]*hpmm31)/(hpmmw + hpmm31))
    rem_y.append((Lymw[i]*hpmmw + Lym31[i]*hpmm31)/(hpmmw + hpmm31))
    rem_z.append((Lzmw[i]*hpmmw + Lzm31[i]*hpmm31)/(hpmmw + hpmm31))

for i in range(len(Lxmw)):
    rem_mag.append(np.sqrt(rem_x[i]**2 + rem_y[i]**2 + rem_z[i]**2))
    L_mag_mw.append(np.sqrt(Lxmw[i]**2 + Lymw[i]**2 + Lzmw[i]**2))
    L_mag_m31.append(np.sqrt(Lxm31[i]**2 + Lym31[i]**2 + Lzm31[i]**2))
