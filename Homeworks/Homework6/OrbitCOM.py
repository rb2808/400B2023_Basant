...
# Distance between M33 and M31. 
plt.figure(figsize = (10, 10))
plt.plot(time_m33_m31, dist_m33_m31, label = 'Distance M33 - M31', color = 'b')
plt.title('Distance between M31 and M33', fontsize = 25)
plt.xlabel('Time [Gyrs]', fontsize = 20)
plt.ylabel('Distance [kpc]', fontsize = 20)
#plt.semilogy()
#plt.ylim(25, 60)
...
# Relatice velocity between M33 and M31.
plt.figure(figsize = (10, 10))
plt.plot(time_mw_m31, vel_m33_m31, label = 'Rel. Velocity MW - M31', color = 'r')
plt.title('Relative Velocity between M33 and M31', fontsize = 25)
plt.xlabel('Time [Gyrs]', fontsize = 20)
plt.ylabel('Relative Velocity [km/s]', fontsize = 20)
#plt.semilogy()
#plt.ylim(25, 60)
